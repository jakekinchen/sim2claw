"""Independent strict verifier for OR141's quarantined topology search."""
...
from .pawn_bg_f2_collision_topology_search import CONTRACT_PATH, SCHEMA, load_contract


VERDICT_SCHEMA = "sim2claw.pawn_bg_f2_collision_topology_search_verdict.v1"
...
def verify_trace(*, trace_path: Path, metadata_path: Path, contract_path: Path = CONTRACT_PATH) -> dict:
    ...
    strict = verify_strict_trace(
        ...
        verdict_schema="sim2claw.pawn_bg_f2_collision_topology_search_strict_verdict.v1",
    ...
    compatibility = (
        _compatibility_gate(
            ...
            arrays=arrays,
            metadata=metadata,
            source_timestamps=_source_episode(contract)["timestamps"],
