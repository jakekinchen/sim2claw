...
| `runs/`, `outputs/`, `output/`, `artifacts/`, `datasets/`, `checkpoints/`, `tmp/`, `dist/` | Mixed experiment inputs, outputs, media, releases and temporary files | Preserve pending classification; specific entries above explain known exceptions |
