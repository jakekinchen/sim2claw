...
Active card: OR23; one-branch-or-insufficient discriminator frozen
Completed: immutable predecessor C0-C9; OR0-OR22; OR7C/OR7D not run because their prerequisite failed; camera endpoint REAL-to-SIM 1/1
Evidence: OR19 produced 47.513 mm of exact-action D2 progress; OR20 localized the remaining failure to object orientation/contact consequence at sample 248; OR21 reproduces OR19 exactly and shows unilateral contact/slip at 231, tilt over 5 degrees at 248, bilateral contact at 255, and sustained support loss at 260.
...
Remaining: full matching task outcome, exact intrinsics, pristine heldout extrinsics, and globally approved mapping remain unapproved. Contact/lift/carry timing is reconciled, but physical pawn-axis orientation is unobserved. OR23 must determine whether any single mechanism is identifiable without that channel.
...
Next step: evaluate the frozen samples 210–300 discriminator and select exactly one causal branch or emit MECHANISM_NOT_IDENTIFIABLE
```
