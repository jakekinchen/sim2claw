...
Next step: preserve OR34 as the correct observation-conditioned visual twin; the next causal correction requires independently constrained jaw/contact/load-path evidence rather than further command-trajectory fitting
```
