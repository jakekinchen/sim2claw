...
```text
Current state: COMPLETE_OR23_ALIGNED_EVENT_TIMING_MECHANISM_NOT_IDENTIFIABLE
Active card: none
Completed: immutable predecessor C0-C9; OR0-OR23; OR7C/OR7D and OR24/OR25 not run because their prerequisites failed; camera endpoint REAL-to-SIM 1/1
Evidence: OR19 produced 47.513 mm of exact-action D2 progress; OR20 localized the remaining failure to object orientation/contact consequence at sample 248; OR21 reproduces OR19 exactly and shows unilateral contact/slip at 231, tilt over 5 degrees at 248, bilateral contact at 255, and sustained support loss at 260. OR23 confirms all three coarse physical/simulator event correspondences but selects no mechanism.
...
Next admissible input: an independently timestamped and calibrated physical pawn-orientation/support trace or a direct contact-force/contact-state witness; do not infer it from task outcome
```
