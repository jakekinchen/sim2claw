...
```text
Current state: COMPLETE_OR12_TRANSLATION_CANDIDATE_MATERIAL_GAP_REDUCTION_NO_CONTACT
Active card: none
Completed: immutable predecessor C0-C9; OR0-OR12; OR7C/OR7D not run because their prerequisite failed; camera endpoint REAL-to-SIM 1/1
Evidence: OR12 artifact c4fee2fa113aaecce400b596ae37f0bcb334823307e2a5f27a63f712cc7be685; exact STL identity passes within 1.001 mm; translation candidate uncertainty 2.695 mm; sample-232 fixed-jaw gap 61.693→26.580 mm; phase minimum 19.665 mm; planar midpoint error 76.858→27.049 mm; vertical midpoint residual -85.272 mm; 0 named contacts; 0 dynamics
Remaining: direct base-height or articulated wrist vertical registration is absent; yaw is frozen but unapproved; global mapping and matching action-to-task outcome remain false
External boundary: a new independent vertical/base-height or multi-pose articulated registration measurement is required before one further mechanism can be declared; hardware authority remains false
