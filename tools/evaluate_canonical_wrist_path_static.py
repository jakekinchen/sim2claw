#!/usr/bin/env python3
"""Run the frozen canonical wrist/path static successor."""
...
from sim2claw.canonical_wrist_path_static import enumerate_and_freeze
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=REPO_ROOT
        / "configs/evaluations/canonical_wrist_path_static_v3.json",
    )
