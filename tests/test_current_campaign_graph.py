...
def test_current_campaign_graph_is_reproducible_and_backtrackable() -> None:
    ...
    assert tracked["active_pointer"] == {
        "node_id": (
            "checkpoint:calibration-graph-d405-wrist-corner-shape-contract-v6-frozen"
        ),
        "milestone_id": "CC03",
        "status": "fresh_wrist_heldout_frozen_before_frame_open",
        "queue_status": "ACTIVE_CC03_WRIST_FRESH_V4_EVALUATE",
        "resume_action": "evaluate_fresh_wrist_v4_once",
    ...
    assert tracked["revision_timeline"][-1]["event_id"] == (
        "CALIBRATION_GRAPH_D405_WRIST_CORNER_SHAPE_CONTRACT_V6_FROZEN"
    )
